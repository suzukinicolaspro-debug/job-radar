...
CASOS_COMBINA_COM = [
    ...
    ("mercado-confirmado-dispensa-idioma-no-titulo", "Data Analyst", "Remote - Espanha", "Remoto", PERFIL_INTL, True),
    ...
    ("cargo-forte-cidade-aceita-passa", "Analista de Dados Júnior", "Campinas, SP", "Presencial", PERFIL_BR, True),
    # keywords_ambiguo (ex: "Business Analyst") só conta com qualificador
    # de dados junto no título — sozinho é ruído de outra área (RH,
    # finanças).
    ("cargo-ambiguo-sem-qualificador-barrado", "Business Analyst", "Campinas, SP", "Presencial", PERFIL_BR, False),
    ("cargo-ambiguo-com-qualificador-passa", "Business Analyst com SQL", "Campinas, SP", "Presencial", PERFIL_BR, True),
    # somente_junior (novo): Pleno/Sênior explícitos são barrados mesmo
    # com cargo e cidade batendo; título sem nível nenhum passa igual.
    ("somente-junior-barra-pleno", "Analista de Dados Pleno", "Campinas, SP", "Presencial", PERFIL_BR, False),
    ("somente-junior-barra-senior", "Cientista de Dados Sênior", "Campinas, SP", "Presencial", PERFIL_BR, False),
    ("somente-junior-passa-sem-nivel", "Cientista de Dados", "Campinas, SP", "Presencial", PERFIL_BR, True),
]
