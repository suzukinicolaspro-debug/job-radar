...
# Regra primária: cidade aceita (Campinas/São Paulo/Osasco) ou "Remoto" com
# mercado Brasil/LATAM/Portugal/Espanha aceito (ver Job.escopo_remoto).
#
# somente_junior=True: filtro rígido (não é só o bônus de score) pedido
# pelo usuário — só passa vaga classificada como Júnior ou sem nível nenhum
# no título (ver _nivel_e_junior_ou_neutro em job.py); barra Pleno e
# Sênior+ explícitos.
